...
export const ESPECIES = ['PINUS', 'EUCALIPTO'];
export const BITOLAS = [1.5, 1.8, 2.2, 2.5, 2.7, 3.1, 3.3];
export const TURNOS = ['00:00 - 06:00', '06:00 - 12:00', '12:00 - 18:00', '18:00 - 00:00'];
...
export const SPINNER = '<div style="width: 32px; height: 32px; margin: 0 auto; border: 3px solid var(--color-border); border-top-color: var(--green-400); border-radius: 50%; animation: spin 1s linear infinite;"></div>';
...
export function headerHtml(title, backHash) {
  return `
...
export function renderErro(container, mensagem) {
  container.innerHTML = `
...
export function toggleHtml(id, opcoes, selecionado, formatar) {
...
export function selectHtml(id, opcoes, selecionado, formatar) {
